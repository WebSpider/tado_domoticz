...
# This script fetches inside temperature and humidity and publishes it to a
# virtual temp/humid Domoticz device
#
#
#
...
try:
  ...
  tadoinsideTemp = res["insideTemperature"]["celsius"]
  tadohumidity = res["humidity"]["percentage"]

domoticzurl = ("http://" + domoticzURL + "/json.htm?type=command&param=udevice&idx=" + domoticzIDX + "&nvalue=0&svalue=" + str(tadoinsideTemp) + ";" + str(tadohumidity) + ";0")
